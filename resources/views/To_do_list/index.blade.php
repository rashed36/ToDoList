          ...
          <div class="col">
            <div class="card" id="list1" style="border-radius: .75rem; background-color: #eff1f2;">
              <div class="card-body py-4 px-4 px-md-5">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <a href="{{route('end.tasks.show')}}" class="btn btn-info">See Complete Task</a>
                  </div>
                ...
                <ul class="list-group list-group-horizontal rounded-0 bg-transparent">
                    ...
                    <li class="list-group-item ps-3 pe-0 py-1 rounded-0 border-0 bg-transparent">
                      <div class="d-flex flex-row justify-content-end mb-1">
                        <a href="{{ route('complete.tasks', $item->id) }}" class="text-primary" data-mdb-toggle="tooltip" title="Complete todo">
                          <i class="fas fa-check me-3"></i>
                        </a>
                        <a href="{{ route('tasks.edit', $item->id) }}" class="text-info" data-mdb-toggle="tooltip" title="Edit todo">
